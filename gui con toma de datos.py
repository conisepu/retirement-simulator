...
def clicked():
    ...
    JubilacionDeseada=txtB1.get()
 
    txtA2.configure(text= ResA)
...
v0=IntVar()
v0.set(1)
r1=Radiobutton(window, text="Masculino", variable=v0,value="hombre")
r2=Radiobutton(window, text="Femenino", variable=v0,value="mujer")
r1.place(x=140,y=95)
r2.place(x=240, y=95)
